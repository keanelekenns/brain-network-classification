...
This modified local search algorithm can be seen in the provided replication package\footnote{The replication package for this paper can be found at https://github.com/keanelekenns/contrast-subgraph.}, and was found to increase the accuracy of the classifiers that used it over the original implementation.
